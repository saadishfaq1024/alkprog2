...
const rows = [
  ...
  { id: "payor_first", disablePadding: true, label: "First Name" },
  { id: "payor_last", disablePadding: true, label: "Last Name" },
  { id: "start_range", disablePadding: true, label: "Start Date Range" },
  { id: "end_range", disablePadding: true, label: "End Date Range" },
...
class InvoicesTable extends React.Component {
  ...
  componentDidMount() {
    ...
    if (!this.state.intervalIsSet) {
      ...
      console.log("Invoice interval set!");
    }
  }
  ...
  componentWillUnmount() {
    if (this.state.intervalIsSet) {
      ...
      console.log("Unmounted from invoice data!");
    }
  }
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center">{n.payor_first}</TableCell>
                        <TableCell align="center">{n.payor_last}</TableCell>
                        <TableCell align="center">{n.start_range}</TableCell>
                        <TableCell align="center">{n.end_range}</TableCell>
